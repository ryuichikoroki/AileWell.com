...
<header x-data="{ open: false }" data-header
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 lg:h-[72px]">
            ...
            <nav class="hidden lg:flex items-center gap-1">
                <a href="index.html"   data-nav="index.html"   class="nav-link-effect px-4 py-2 text-sm font-medium text-white/90 rounded-lg hover:bg-white/10 transition-colors">Home</a>
            ...
            <div class="flex items-center gap-3">
                ...
                <button @click="open = !open" class="lg:hidden p-2 rounded-lg hover:bg-white/10 transition-colors" :aria-expanded="open" aria-label="Open menu">
    ...
    <div x-show="open"
        ...
        <nav class="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-1">
            <a href="index.html"   data-nav-m="index.html"   class="px-4 py-3 text-white/90 font-medium rounded-lg hover:bg-white/10 transition-colors">Home</a>
...
<footer class="bg-[#0d1929] text-white/90 relative z-[1]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 md:pt-20">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 pb-12 md:pb-16 border-b border-white/10">
            ...
            <div>
                <p class="text-xs font-bold tracking-[0.15em] text-white/40 uppercase mb-4">Support</p>
                <nav class="flex flex-col gap-3">
                    <a href="contact.html" class="text-white/75 text-sm hover:text-white transition-colors">Contact</a>
                    <a href="access.html"  class="text-white/75 text-sm hover:text-white transition-colors">Access</a>
                    <a href="privacy.html" class="text-white/75 text-sm hover:text-white transition-colors">Privacy Policy</a>
                </nav>
            </div>
            <div>
